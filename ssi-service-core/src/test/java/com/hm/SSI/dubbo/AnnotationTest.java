...
public class AnnotationTest {
    ...
    public void testAnnotation() {
        ...
        System.out.println(AnnotationTest.class.getPackage().getName().replace('.', '/') + "/annotation-provider.xml");
        ...
        try {
            ...
            System.out.println(AnnotationTest.class.getPackage().getName().replace('.', '/') + "/annotation-consumer.xml");
